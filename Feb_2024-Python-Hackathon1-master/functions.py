...
def fibonacci(n):
  ...
  """
  if n <= 1:
    return [0] * n  # Create a list of n zeros for the first two numbers (0, 1)
  else:
    a, b = 0, 1  # Initialize the first two Fibonacci numbers
    fibonacci_sequence = [a, b]  # Start the sequence with 0 and 1
    for _ in range(2, n + 1):
      c = a + b
      fibonacci_sequence.append(c)  # Append the new term to the sequence
      a, b = b, c  # Update the previous two numbers for the next iteration
